...
Le format Standard affiche le contenu complet. Le format Compact affiche l’icône et uniquement le titre, avec la couleur de priorité, l’action facultative et la fermeture lorsqu’elle est autorisée.
